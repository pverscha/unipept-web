    ...
    <v-container>
        ...
        <header-body-card title="Overview" id="overview" class="mb-5">
            <div class="d-flex justify-center">
                <v-img
                    :src="require('@/assets/documentation/desktop/comparative_analysis/desktop_comparison_overview.png')"
                    max-width="800"
                    contain
                    eager
        ...
        <header-body-card title="Intra-assay comparison" id="intra_assay_comparison" class="mb-5">
            ...
            <div class="d-flex justify-center">
                <v-img
                    :src="require('@/assets/documentation/desktop/comparative_analysis/desktop_comparison_intra_assay_overview.png')"
                    max-width="800"
                    contain
                    eager
                    class="screenshot ma-6" />
            ...
            <div class="d-flex justify-center">
                <v-img
                    :src="require('@/assets/documentation/desktop/comparative_analysis/desktop_comparison_intra_assay_result.png')"
                    max-width="800"
                    contain
                    eager
                    class="screenshot ma-6" />
        ...
        <header-body-card title="Inter-assay comparison" id="inter_assay_comparison" class="mb-5">
            <p>
            ...
            <div class="d-flex justify-center">
                <v-img
                    :src="require('@/assets/documentation/desktop/comparative_analysis/desktop_comparison_project_explorer.png')"
                    max-width="800"
                    contain
                    eager
                    class="screenshot" />
            ...
            <v-alert color="info" outlined class="mt-2">
                <span class="font-weight-bold">Remark:</span>
            ...
            <h3 class="mt-2">Visualization</h3>
            <p>
            ...
            <div class="d-flex align-center flex-column">
                <v-img
                    :src="require('@/assets/documentation/desktop/comparative_analysis/desktop_comparison_heatmap.png')"
                    max-width="800"
                    contain
                    eager
                    class="ma-6" />
