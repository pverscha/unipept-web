<template>
    <v-container>
        ...
        <v-container v-if="releases.length == 5" class="pa-0 d-flex justify-end">
            <a href="https://github.com/unipept/unipept-web/releases" target="_blank">View all releases on github</a>
...
import WebReleaseParser from '@/logic/parsers/github/DescriptionChangelogParser';

const githubCommunicator = new GithubCommunicator();
const releaseParser = new WebReleaseParser();
