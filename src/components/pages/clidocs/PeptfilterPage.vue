    ...
    <v-container>
        ...
        <HeaderBodyCard title="Output" class="mt-5">
            <p>
                ...
                with a length lower than 5 or higher than 50 are removed. The length filter can be changed by using the <RLink to="clioptions" anchor>--minlen</RLink> 
                and <RLink to="clioptions" anchor>--maxlen</RLink> parameters. Peptides can also be filtered based on whether or not they lack or contain certain amino 
                acids. This can be done with the <RLink to="clioptions" anchor>--lacks</RLink> and <RLink to="clioptions" anchor>--contains</RLink> parameters. 
            </p>
        </HeaderBodyCard>
