    ...
    <v-container>
        ...
        <HeaderBodyCard title="Output" class="mt-5">
            <p>
                ...
                <RLink to="clioptions" anchor>--all parameter</RLink>, this can be supplemented with the name of the associated taxon and several cross referenes such 
                ...
                be specified with the <RLink to="clioptions" anchor>--select parameter</RLink>. By default, output is generated in csv format. By using the 
                <RLink to="clioptions" anchor>--format parameter</RLink>, the format can be changed into json or xml. The output can be written to a file or to 
                <i>standard output</i>. 
            </p>
