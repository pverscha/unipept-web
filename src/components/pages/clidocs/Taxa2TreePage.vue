<template>
    <v-container>
        ...
        <h3 class="font-weight-light">Returns the taxonomic tree of a given list of taxon identifiers.</h3>
        
        <v-divider class="my-2" />

        <p>
            The <Code>unipept taxa2lca</Code> command takes one or more <Initialism>NCBI</Initialism> taxon id's as input and returns the taxonomic tree of these 
            taxa as output. All this information is fetched by doing  <RLink to="/apidocs/taxa2tree" router><Initialism>API</Initialism>-requests</RLink> to the 
            Unipept server.
        </p>
        ...
        <HeaderBodyCard title="Input">
            ...
            <p>
                If the command is run without arguments and no file is specified, <Code>unipept taxa2tree</Code> will read its input from <i>standard input</i>. 
