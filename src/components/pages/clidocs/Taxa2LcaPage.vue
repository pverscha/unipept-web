    ...
    <v-container>
        ...
        <HeaderBodyCard id="output" title="Output" class="mt-5">
            <p>
                ...
                the <RLink to="options" anchor>--all parameter</RLink>, this can be supplemented with the full taxonomic lineage of the <Initialism>LCA</Initialism>. 
                ...
                of output fields can be specified with the <RLink to="options" anchor>--select parameter</RLink>. By default, output is generated in csv format. 
                By using the <RLink to="options" anchor>--format parameter</RLink>, the format can be changed into json or xml. The output can be written to a file 
