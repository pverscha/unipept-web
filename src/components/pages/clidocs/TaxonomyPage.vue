    ...
    <v-container>
        ...
        <HeaderBodyCard title="Output" class="mt-5">
            <p>
                ...
                rank of each taxon id are returned. By using the <RLink to="clioptions" anchor>--all parameter</RLink>, this can be supplemented with the full 
                ...
                list of output fields. A selection of output fields can be specified with the <RLink to="clioptions" anchor>--select parameter</RLink>. By default, 
                output is generated in csv format. By using the <RLink to="clioptions" anchor>--format parameter</RLink>, the format can be changed into json or xml. 
