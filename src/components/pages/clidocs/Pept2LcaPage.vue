    ...
    <v-container>
        ...
        <HeaderBodyCard title="Output" class="mt-5">
            <p>
                ...
                <RLink to="clioptions" anchor>--all parameter</RLink>, this can be supplemented with the full taxonomic lineage of the <Initialism>LCA</Initialism>. Consult the 
                ...
                with the <RLink to="clioptions" anchor>--select parameter</RLink>. By default, output is generated in csv format. By using the 
