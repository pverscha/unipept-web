    ...
    <v-container>
        ...
        <HeaderBodyCard id="output" title="Output" class="mt-5">
            <p>
                ...
                <RLink to="options" anchor>--all parameter</RLink>, this can be supplemented with the full taxonomic lineage of the <Initialism>LCA</Initialism>. Consult the 
                ...
                with the <RLink to="options" anchor>--select parameter</RLink>. By default, output is generated in csv format. By using the 
